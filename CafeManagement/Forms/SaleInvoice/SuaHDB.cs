...
{
    public partial class SuaHDB : Form
    {
        public SuaHDB(string maHDB, string ngayBan, string maNV, string maKH, string tongTien)
        {
            InitializeComponent();
        ...
        private void btnXacNhan_Click(object sender, EventArgs e)
        {
            ...
            if (!Functions.IsDate(txtMaHoaDonBan.Text))
            {
            ...
            sql = "INSERT INTO sale_invoices(id, sale_date, employee_id, customer_id, total_amount) VALUES (" +
                  ...
                  "N'" + Functions.ConvertDateTime(txtMaHoaDonBan.Text) + "', " +
